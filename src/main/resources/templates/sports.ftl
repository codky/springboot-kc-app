...
<div id="header">
    <img id="logo" style="height: 150px; width: 150px; border-radius: 100%; padding: 15px 15px 15px 15px" src="http://localhost:8090/hi5code/assets/img/mylogo.png" alt="hi5code.com">
...
<div id="menu">
    <ul id="menubar">
        ...
        <li><a class="info active" href="/hi5code/private/user/sports">Sports</a></li>
...
<div id="content" style="width:60%; margin:0 auto;">
    ...
    <h2 align="center" style="color:dodgerblue;margin-top: 90px;">Make some Noise !!!! We're in a Sports Ground !!!</h2>
